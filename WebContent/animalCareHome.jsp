...
<!-- 	Just some stuff you need -->
	...
	%>
		...
		<h1>eZoo</h1><h1><small>Animal Care</small></h1>
			...
			<tbody>
				<c:forEach var="animal" items="${animals}">
					<tr>
						...
						<td><fmt:formatNumber value="${animal.feeding_schedule}"/></td>
					
						<td>
							<c:if test="${animal.feeding_schedule == 0}">
							...
							<c:if test="${animal.feeding_schedule >= 1}">
