                ...
                <ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                          <li><a href="animalCare">Animal Care Home</a></li>
                          <li><a href="feedingSchedules">Feeding Schedule Home</a></li>
                          <li class="divider"></li>
                          <li><a href="addAnimal">Add an Animal</a></li>
                         
                          <li><a href="addFeedingSchedule">Create a Feeding Schedule</a></li>
                          
                          
                        </ul>
                    </li>
                    <!--  <li class="dropdown">
                        <a tabindex="-1" href="#" class="dropdown-toggle" data-toggle="dropdown"><b class="caret"></b></a>
                        <ul class="dropdown-menu">
                          <li><a href="eventManagement"></a></li>
                          <li class="divider"></li>
                     ...
                     <li class="dropdown">
                        <a tabindex="-1" href="#" class="dropdown-toggle" data-toggle="dropdown"><b class="caret"></b></a>
                        <ul class="dropdown-menu">
                          <li><a href="employeeManagement"></a></li>
                          <li class="divider"></li>
