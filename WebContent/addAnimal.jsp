...
<!-- 	Just some stuff you need -->
	...
	%>
		...
		<h1>eZoo</h1><h1><small>Add an Animal</small></h1>
		...
		<form action="addAnimal" method="post" class="form-horizontal">
		  ...
		  <div class="form-group">
		   ...
		   <div class="form-group">
		    <label for="feeding_schedule" class="col-sm-4 control-label">Feeding Schedule ID</label>
		    <div class="col-sm-5">
		      <input type="number" class="form-control" id="feeding_schedule" name="feeding_schedule" placeholder="Feeding Schedule ID" required="required"/>
		    </div>
		  </div>
		  <div class="form-group">
